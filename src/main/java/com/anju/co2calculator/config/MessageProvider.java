...
public class MessageProvider {
    ...
    public static final String NO_ARGUMENTS_PROVIDED = "No arguments provided. Ensure you provide --start, --end, and --transportation-method.";
    public static final String MISSING_ARGUMENT = "Missing required parameters. Ensure you provide --start, --end, and --transportation-method.";
    ...
    public static final String INVALID_TRANSPORT = "Choosen transportation method is invalid";
    ...
    public static final String INVALID_START_LOCATION = "Invalid start location";
    public static final String INVALID_END_LOCATION = "Invalid end location";
